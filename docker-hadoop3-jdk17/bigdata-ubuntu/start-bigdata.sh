...
# 压缩上传
zip -jr spark-jars.zip /usr/bigdata/spark-3.5.9-bin-hadoop3/jars/*
hadoop fs -put -f spark-jars.zip /user/spark/spark-jars.zip
hadoop fs -put -f /usr/bigdata/spark-3.5.9-bin-hadoop3/jars/spark-yarn_2.12-3.5.9.jar /user/spark/jars/spark-yarn_2.12-3.5.9.jar
